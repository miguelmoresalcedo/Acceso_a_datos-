...
public class BufferReaderyWritter {
	...
	public static void escribirFicheroV1(String[] lista)
	{
		try 
		{
			...
			BufferedWriter ficheroBuffer = new BufferedWriter(ficheroEscritura); //es el write del string
	...
	public static void leerFicheroV1(String[] lista)
	{
		try 
		{
			...
			// 2. Leer nombre con string, cuando read devuelve null se ha llegado al final del fichero
			//    (se puede cambiar)
			int i = 0;
			String linea;
			linea = ficheroBuffer.readLine(); //esto funciona con cualquier fichero
